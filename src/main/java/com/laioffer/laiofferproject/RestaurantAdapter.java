...
/**
 * Created by daisy on 11/20/2017.
 */
...
public class RestaurantAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.resturant_item,
                    parent, false);
        }

        //ImageView view = (ImageView) convertView.findViewById(R.id.restaurant_thumbnail);
        ...
        if (position < 2) {
            ...
            restuarantImage.setImageDrawable(context.getDrawable(R.drawable.peach));
        } else {
            restuarantImage.setImageDrawable(context.getDrawable(R.drawable.watermelon));
        } */
